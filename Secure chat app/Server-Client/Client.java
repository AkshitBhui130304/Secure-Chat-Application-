...
class icons3 {
    icons3(Client s) {
        ...
        frame.setBounds(900, 20, 200, 130);
        ...
        b4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                dframe.setBounds(420, 0, 400, 400);
...
public class Client extends JFrame implements ActionListener {
    ...
    Client() {
        ...
        // User profile image
        ImageIcon Icon2 = new ImageIcon(ClassLoader.getSystemResource("icons/Tam.png"));
        ...
        JLabel name = new JLabel("Dr Tamanna");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (comm.equals("Send")) {
            ...
            emojiFrame.setBounds(700, 550, 5, 200);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            c.dout = new DataOutputStream(s.getOutputStream());
            ...
            while (true) {
                ...
                c.Format(msgout, 1); // Format and display the message
